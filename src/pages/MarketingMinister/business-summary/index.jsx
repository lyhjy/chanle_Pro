  ...
  constructor(props){
    ...
    this.state = {
      ...
      columns: [{
        ...
        title: '预计业务毛利/元', dataIndex: 'rsRate', key: 'rsRate', hideInSearch: true, align: 'center',render: (_, recode) => <span>{`${_}元`}</span>
      }, {
        title: '实际业务毛利/元', dataIndex: 'costRate', key: 'costRate', hideInSearch: true, align: 'center',render: (_, recode) => <span>{`${_}元`}</span>
      }],
    }
  }
